...
namespace RTEditor
{
    ...
    public class EditorObjectSelection : MonoSingletonBase<EditorObjectSelection>
    {
        ...
        public delegate void SelectionCreatedHandler(GameObject createdObject);
        public event SelectionCreatedHandler SelectionCreated;
        ...
        public void OnCreated(GameObject createdObject)
        {
            if (SelectionCreated != null)
            {
                if (SelectionCreated != null) SelectionCreated(createdObject);
            }
        }
